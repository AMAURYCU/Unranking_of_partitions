"""Micro-benchmarks for ordered_lah_partitions.

Run with: python -m ordered_lah_partitions.bench
"""
...
def bench(iterations: int = 10000):
    print("Benchmarks for ordered_lah_partitions ({} iterations)".format(iterations))
