"""Micro-benchmarks for stirling_partitions.

Run with: python -m stirling_partitions.bench
"""
...
def bench(iterations: int = 10000):
    print("Benchmarks for stirling_partitions ({} iterations)".format(iterations))
