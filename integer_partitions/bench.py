"""Micro-benchmarks for integer_partitions.

This file times simple functions from numbers, combinatorial and lexicographic.
Run with: python -m integer_partitions.bench
"""
...
def bench(iterations: int = 10000):
    print("Benchmarks for integer_partitions ({} iterations)".format(iterations))
